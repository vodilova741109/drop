const wrapper = document.querySelector('.wrapper'),
    empty= document.querySelector('.baza'),
...
for ( let draggableElem of draggableElems ) {
    ...
    // let itemAppend;
      ...
      function dragMove(event) {    
        ...
        // //   empty.forEach(item =>{
        //       if(draggableElem.getBoundingClientRect().top + draggableElem.offsetHeight / 2 < empty.getBoundingClientRect().bottom &&
        //           draggableElem.getBoundingClientRect().right - draggableElem.offsetWidth / 2 > empty.getBoundingClientRect().left &&        
        //           draggableElem.getBoundingClientRect().bottom - draggableElem.offsetHeight / 2 > empty.getBoundingClientRect().top &&
        //           draggableElem.getBoundingClientRect().left + draggableElem.offsetWidth / 2 < empty.getBoundingClientRect().right
        //       ){
